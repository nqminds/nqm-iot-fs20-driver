...
module.exports = (function() {
  var console = { log: require("debug")("fs20Driver") }
  ...
  FS20Driver.prototype.start = function() {
    ...
    this._serialPort = new SerialPort(this._config.port, { parser: SerialPort.parsers.readline(delimiter), baudrate: 38400 }, function(err) {
      if (err) {
